...
public class Vi {
		...
		public String toString() {
				String paraula = String.format("%n    Ref: %s%n    Nom: %s%n    Preu: %d%n    Estoc: %d%n    Lloc: %s%n    Origen: %s%n    Tipus: %s%n    Collita: %s%n" ,this.ref,this.nom,preu,estoc, this.lloc, this.origen, this.tipus, this.collita);
				return paraula;
		}
