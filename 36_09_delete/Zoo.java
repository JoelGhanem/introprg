...
public class Zoo {
  ...
  public void eliminaAnimal(Animal animal) throws SQLException {
    if(animal == null || animal.idIndefinit()){
      return ;
    }
  ...
  public void eliminaCategoria(Categoria categoria) throws SQLException {
    ...
    sql = String.format("delete from animals where categoria = "+ categoria.getId() + ";delete from categories where id = "+ categoria.getId())+ ";"; 
    Statement st = null;
