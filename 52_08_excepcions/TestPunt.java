...
public class TestPunt {
		...
		@Test 
		public void lanzaXNegativa() {
				Punt p = new Punt(-1,0);
				assertThrows(IllegalArgumentException.class, ()-> new Punt(-1,0));
		}
		@Test 
		public void lanzaYNegativa() {
				Punt p = new Punt(1,-1);
				assertThrows(IllegalArgumentException.class, ()-> new Punt(1,-1));
		}
		@Test 
		public void lanza2Negativas() {
				Punt p = new Punt(-1,-1);
				assertThrows(IllegalArgumentException.class, ()-> new Punt(-1,-1));
		}
}
